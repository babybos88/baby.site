...
!function() {
    var e, n = {
            ...
            function(e) {
                ...
                e((function() {
                    e(".hot-games.wrapper").mouseover((function() {
                        e(this).children(".img-container").addClass("pause"),
                        e(this).children(".img-container").removeClass("run")
                    }
                    )).mouseout((function() {
                        e(this).children(".img-container").removeClass("pause"),
                        e(this).children(".img-container").addClass("run")
                    }
                    ))
                }
                )),
                ...
                if (e(".footer-body").length) {
                    ...
                    e("#collapsible-footer").click((function(t) {
                        return e(".mobile .footer-title .i-collapse").toggleClass("rotate"),
            ...
            window.bindBankRegFormVal = function(e) {
                ...
                $(e).submit((function(e) {
                    ...
                    errorPlacement: function(e, t) {
                        e.addClass("help-block"),
                        t.addClass("has-feedback"),
                        "checkbox" === t.prop("type") ? e.insertAfter(t.parent("label")) : "radio" === t.prop("type") ? e.insertBefore(t.parent().parent()) : e.insertAfter(t),
                        t.next("i")[0] || $("<i class='icon-cancel form-control-feedback absolute'></i>").insertAfter(t)
                    },
                    success: function(e, t) {
                        $(t).next("i")[0] || $("<i class='icon-checkmark  form-control-feedback absolute'></i>").insertAfter($(t))
                ...
                $(e).submit((function(e) {
                    ...
                    submitHandler: function(e, t) {
                        ...
                        return json_post("/add-user-bank", n).done((function(t) {
                            ...
                            n.html(""),
                            n.append('<option selected value="">Pilih <span class="txt_metod_name">Pulsa</span> </option>');
                            var a = t.data;
                            if (a && a.length > 0) {
                                ...
                                $("#full_name") && ($("#full_name").val(t.data[0].acc_name),
                                $("#full_name").prop("readonly", !0))
                            }
                            return n.data("originalHTML", n.html()),
                    ...
                    (a = jQuery).fn.extend({
                        slimScroll: function(e) {
                            ...
                            return this.each((function() {
                                var o, i, r, s, l, c, u, d, m = "<div></div>", h = !1, f = a(this);
                                if (f.parent().hasClass(n.wrapperClass)) {
                                    var p = f.scrollTop();
                                    if (w = f.siblings("." + n.barClass),
                                    $ = f.siblings("." + n.railClass),
                                    C(),
                                    a.isPlainObject(e)) {
                                    ...
                                    var $ = a(m).addClass(n.railClass).css({
                                        width: n.size,
                                        height: "100%",
                                        position: "absolute",
                                        top: 0,
                                    ...
                                    f.parent().append(w),
                                    f.parent().append($),
                                    n.railDraggable && w.bind("mousedown", (function(e) {
                                        var n = a(document);
                                        return r = !0,
                                    ...
                                    f.bind("touchmove", (function(e) {
                                        ...
                                        e.originalEvent.touches.length && (x((l - e.originalEvent.touches[0].pageY) / n.touchScrollStep, !0),
                                    ...
                                    x(0, !0)) : "top" !== n.start && (x(a(n.start).position().top, null, !0),
                                    n.alwaysVisible || w.hide()),
                                    this,
                                    window.addEventListener ? (this.addEventListener("DOMMouseScroll", y, !1),
                                    this.addEventListener("mousewheel", y, !1)) : document.attachEvent("onmousewheel", y)
                                }
                                function y(e) {
                                    if (o) {
                                        var t = 0;
                                        ...
                                        a(i).closest("." + n.wrapperClass).is(f.parent()) && x(t, !0),
                                ...
                                function x(e, t, a) {
                                    h = !1;
                                    var o = e
                                      , i = f.outerHeight() - w.outerHeight();
                                    if (t && (o = parseInt(w.css("top")) + e * parseInt(n.wheelStep) / 100 * w.outerHeight(),
                                    o = Math.min(Math.max(o, 0), i),
                                    o = e > 0 ? Math.ceil(o) : Math.floor(o),
                                    w.css({
                                        top: o + "px"
                                    })),
                                    o = (u = parseInt(w.css("top")) / (f.outerHeight() - w.outerHeight())) * (f[0].scrollHeight - f.outerHeight()),
                                    a) {
                                ...
                                function C() {
                                    c = Math.max(f.outerHeight() / f[0].scrollHeight * f.outerHeight(), 30),
                                    w.css({
                                        height: c + "px"
                                    });
                                ...
                                function _() {
                                    ...
                                    u == ~~u) {
                                        ...
                                        h = !1;
                                    d = u,
                                    c >= f.outerHeight() ? h = !0 : (w.stop(!0, !0).fadeIn("fast"),
                                    n.railVisible && $.stop(!0, !0).fadeIn("fast"))
                                }
                                function P() {
                                    n.alwaysVisible || (s = setTimeout((function() {
                                        n.disableFadeOut && o || i || r || (w.fadeOut("slow"),
                                        $.fadeOut("slow"))
                                    }
                                    ), 1e3))
                                }
        ...
        473: function() {
            ...
            $(document).on("click", "#btn-close--login-modal", (function() {
                return $("#login-modal--layout").nifty("hide"),
                !1
            }
            )),
            $(document).on("click", "#btn-showSocialIcons--top-bar", (function() {
                return $("#blk-socialIcons--top-bar").toggleClass("show"),
                $("#btn-showSocialIcons--top-bar>i").toggleClass("hide"),
                !1
            }
            )),
            $(document).on("click", "#btn-showMenuOption--top-bar", (function() {
                return $("#blk-MenuOption--top-bar").toggleClass("show"),
                $("#btn-MenuOption--top-bar>i").toggleClass("hide"),
                !1
            }
            )),
            $(document).on("click", "#btn-showhelpIcons--nexttop-bar", (function() {
                return $("#blk-helpIcons--nexttop-bar").toggleClass("show"),
                $("#btn-showhelpIcons--nexttop-bar>i").toggleClass("hide"),
                !1
            }
            ))
        },
        ...
        402: function() {
            ...
            $(document).on("click", "#minus-btn", (function() {
                ...
                $("#minus-btn").hasClass("disabledBtn") && $("#minus-btn").removeClass("disabledBtn")) : $("#minus-btn").addClass("disabledBtn"),
                !1
            }
            )),
            $(document).on("click", "#add-btn", (function() {
                ...
                $("#add-btn").hasClass("disabledBtn") && $("#add-btn").removeClass("disabledBtn")) : $("#add-btn").addClass("disabledBtn"),
                !1
            }
            ));
            ...
            var l = function(t, n) {
                ...
                var o = t.length
                  ...
                  , b = function() {
                    ...
                    var t = (Math.round(100 * u) / 100).toFixed(2);
                    if (null !== p) {
                  ...
                  , C = function e(t) {
                    if (d) {
                        ...
                        u = (v + k * l * i + w) % l,
                        b(),
                        o < 1 ? m = requestAnimationFrame(e) : (d = !1,
                ...
                document.querySelector("#spinBtn").addEventListener("click", (function() {
                    var t, n, a;
                    d || (document.getElementById("spinBtn").disabled = !0,
                ...
                t.forEach((function(e, t) {
                    ...
                    i.save();
                    var s, l, u, d = 1;
                    switch (null !== (a = e.item_seq) && void 0 !== a ? a : e.sequence) {
                    case 1:
                        d = 10;
                        break;
                    case 2:
                    ...
                    1 === Number(e.item_id) || 2 === Number(e.item_id)) {
                        var m = r - 55;
                        i.fillText((s = e.amount,
                        l = Math.abs(s),
                        u = Math.sign(s),
                        l >= 1e12 ? u * (l / 1e12).toFixed(1) + "T" : l >= 1e9 ? u * (l / 1e9).toFixed(1) + "B" : l >= 1e6 ? u * (l / 1e6).toFixed(1) + "M" : l >= 1e3 ? u * (l / 1e3).toFixed(1) + "K" : u * l), m, 5),
                        1 === Number(e.item_id) ? i.drawImage(n[0], m + 5, -15, 26, 26) : i.drawImage(n[1], m + 5, -15, 26, 26)
                    } else if (4 === Number(e.item_id)) {
                        var f = e.item.split(" ");
                        i.fillText(f[0] + " " + f[1], r - 20, 5),
                        i.fillText(f[2], r - 40, 20)
                    } else
        ...
        431: function() {
            ...
            $((function() {
                var e, t, n = $(".js-cycling-gallery ul"), a = n.find("li"), o = n.data("count"), i = 1, r = -1 * a.width(), s = r * o, l = !1, c = 0, u = 0;
                if (n.length > 0) {
                ...
                function m(e) {
                    e = e || window.event,
                    l = !0,
                    "touchmove" == e.type ? (u = c - e.touches[0].clientX,
                    c = e.touches[0].clientX) : (u = c - e.clientX,
                    c = e.clientX),
                    n.css({
            ...
            $((function() {
                var e, t, n = $(".js-cycling-gallery-neo ul"), a = n.find("li"), o = n.data("count"), i = 1, r = -1 * a.width(), s = r * o, l = !1, c = 0, u = 0;
                if (n.length > 0) {
                    var d = $(".js-cycling-btn");
                    n.css({
                        left: s
            ...
            $((function() {
                var e, t, n = $(".js-cycling-widthdraw-horizontal ul"), a = n.find("li"), o = n.data("count"), i = 1, r = -1 * a.width(), s = r * o, l = !1, c = 0, u = 0;
                if (n.length > 0) {
                    var d = $(".js-cycling-btn");
                    n.css({
                        left: s
            ...
            $((function() {
                var e, t, n = $(".js-cycling-deposit ul"), a = n.find("li"), o = n.data("count"), i = 1, r = -1 * a.height(), s = r * o, l = !1, c = 0, u = 0;
                if (n.length > 0) {
                    var d = $(".js-cycling-btn");
                    n.css({
                        top: s
                ...
                $(".js-cycling-gallery-ams").each((function(e, t) {
                    ...
                    if (n.length > 0) {
                        ...
                        n.on("touchstart", (function(e) {
                            ...
                            "touchstart" == e.type ? u = e.touches[0].clientX : (u = e.clientX,
                    ...
                    function h(e) {
                        e = e || window.event,
                        s = !0,
                        "touchmove" == e.type ? (d = u - e.touches[0].clientX,
                        u = e.touches[0].clientX) : (d = u - e.clientX,
                        u = e.clientX),
                        n.css({
        ...
        90: function(e) {
            !function(t, n) {
                var a = function(e, t, n) {
                    ...
                    ,
                    ne = function(e) {
                        return null == U && (U = "hidden" == x(t.body, "visibility")),
                        U || !("hidden" == x(e.parentNode, "visibility") && "hidden" == x(e, "visibility"))
                    }
                    ,
                    ae = function(e, n) {
                        var a, o = e, r = ne(e);
                        ...
                        W += n; r && (o = o.offsetParent) && o != t.body && o != i; )
                            ...
                            r = W > a.left && H < a.right && V > a.top - 1 && X < a.bottom + 1);
                        return r
                    }
                    ,
                    oe = function() {
                        var e, n, r, s, c, u, d, m, h, f, p, g, b = a.elements;
                        if ((B = o.loadMode) && Z < 8 && (e = b.length)) {
                            for (n = 0,
                            ee++; n < e; n++)
                                if (b[n] && !b[n]._lazyRace)
                                    if (!J || a.prematureUnveil && a.prematureUnveil(b[n]))
                                        me(b[n]);
                                    else if ((m = b[n][l]("data-expand")) && (u = 1 * m) || (u = Q),
                                    f || (f = !o.expand || o.expand < 1 ? i.clientHeight > 500 && i.clientWidth > 500 ? 500 : 370 : o.expand,
                                    a._defEx = f,
                                    p = f * o.expFactor,
                                    g = o.hFac,
                                    U = null,
                                    Q < p && Z < 1 && ee > 2 && B > 2 && !t.hidden ? (Q = p,
                                    ee = 0) : Q = B > 1 && ee > 1 && Z < 6 ? f : G),
                                    h !== u && (O = innerWidth + u * g,
                                    D = innerHeight + u,
                                    d = -1 * u,
                                    h = u),
                                    r = b[n].getBoundingClientRect(),
                                    (V = r.bottom) >= d && (X = r.top) <= D && (W = r.right) >= d * g && (H = r.left) <= O && (V || W || H || X) && (o.loadHidden || ne(b[n])) && (I && Z < 3 && !m && (B < 3 || ee < 4) || ae(b[n], u))) {
                                        if (me(b[n]),
                                        c = !0,
                                        Z > 9)
                                            break
                                    } else
                                        !c && I && !s && Z < 4 && ee < 4 && B > 2 && (j[0] || o.preloadAfterLoad) && (j[0] || !m && (V || W || H || X || "auto" != b[n][l](o.sizesAttr))) && (s = j[0] || b[n]);
                            s && !c && me(s)
                        }
                    }
                    ,
                    ...
                    de = P((function(e, t, n, a, i) {
                        ...
                        s = e[l](o.srcsetAttr),
                        r = e[l](o.srcAttr),
                        i && (d = (c = e.parentNode) && h.test(c.nodeName || "")),
                        ...
                        s ? e.setAttribute("srcset", s) : r && !d && (K.test(e.nodeName) ? ce(e, r) : e.src = r),
                        i && (s || d) && y(e, {
                            src: r
                        })),
                    ...
                    me = function(e) {
                        if (!e._lazyRace) {
                            var t, n = Y.test(e.nodeName), a = n && (e[l](o.sizesAttr) || e[l]("sizes")), i = "auto" == a;
                            (!i && I || !n || !e[l]("src") && !e.srcset || e.complete || b(e, o.errorClass) || !b(e, o.lazyClass)) && (t = k(e, "lazyunveilread").detail,
                            i && M.updateElem(e, !0, e.offsetWidth),
                            e._lazyRace = !0,
                            Z++,
                            de(e, t, i, a, n))
                        }
                    ...
                    T = function(e, t, n) {
                        ...
                        (a = k(e, "lazybeforesizes", {
                            width: n,
                            dataAttr: !!t
                        })).defaultPrevented || (n = a.detail.width) && n !== e._lazysizesWidth && S(e, o, a, n))
                    }
                    ,
                    L = q((function() {
                        var e, t = F.length;
                    ...
                    {
                        _: function() {
                            F = t.getElementsByClassName(o.autosizesClass),
                            c("resize", L)
                        },
                        checkElems: L,
                        updateElem: T
                      ...
                      , N = function() {
                        !N.i && t.getElementsByClassName && (N.i = !0,
                        M._(),
                        R._())
                    };
                    var F, S, T, L;
                    var j, I, z, B, E, O, D, X, H, W, V, U, Y, K, J, G, Q, Z, ee, te, ne, ae, oe, ie, re, se, le, ce, ue, de, me, he, fe, pe;
        ...
        if (!n) {
            ...
            for (u = 0; u < e.length; u++) {
                ...
                for (var s = !0, l = 0; l < n.length; l++)
                    (!1 & o || r >= o) && Object.keys(i.O).every((function(e) {
                        return i.O[e](n[l])
                    }
                    )) ? n.splice(l--, 1) : (s = !1,
                    o < r && (r = o));
    ...
    i.O(void 0, [187, 479, 279, 774, 258, 862], (function() {
        return i(768)
    }
    )),
    i.O(void 0, [187, 479, 279, 774, 258, 862], (function() {
    ...
    var r = i.O(void 0, [187, 479, 279, 774, 258, 862], (function() {
        return i(94)
    }
    ));
    r = i.O(r)
