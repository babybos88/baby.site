            ...
            var l = function(t, n) {
                ...
                t.forEach((function(e, t) {
                    ...
                    1 === Number(e.item_id) || 2 === Number(e.item_id)) {
                        ...
                        l = Math.abs(s),
                        d = Math.sign(s),
                        l >= 1e12 ? d * (l / 1e12).toFixed(1) + "T" : l >= 1e9 ? d * (l / 1e9).toFixed(1) + "B" : l >= 1e6 ? d * (l / 1e6).toFixed(1) + "M" : l >= 1e3 ? d * (l / 1e3).toFixed(1) + "K" : d * l), m, 5),
                ...
                var a = function(e, t, n) {
                    ...
                    ae = function(e, n) {
                        ...
                        W += n; r && (o = o.offsetParent) && o != t.body && o != i; )
                            ...
                            r = W > a.left && H < a.right && U > a.top - 1 && X < a.bottom + 1);
                        return r
                    }
                    ,
                    oe = function() {
                        ...
                        if ((z = o.loadMode) && Z < 8 && (e = b.length)) {
                            ...
                            ee++; n < e; n++)
                                if (b[n] && !b[n]._lazyRace)
                                    ...
                                    (U = r.bottom) >= u && (X = r.top) <= O && (W = r.right) >= u * g && (H = r.left) <= D && (U || W || H || X) && (o.loadHidden || ne(b[n])) && (I && Z < 3 && !m && (z < 3 || ee < 4) || ae(b[n], d))) {
                                        if (me(b[n]),
                                        c = !0,
                                        Z > 9)
                                            break
                                    } else
                                        !c && I && !s && Z < 4 && ee < 4 && z > 2 && (j[0] || o.preloadAfterLoad) && (j[0] || !m && (U || W || H || X || "auto" != b[n][l](o.sizesAttr))) && (s = j[0] || b[n]);
                            s && !c && me(s)
                        }
                    }
                    ,
                    ...
                    )),
                    {
                      ...
                      , F = function() {
                        !F.i && t.getElementsByClassName && (F.i = !0,
                        R._(),
                        N._())
                    };
                    var M, T, L, S;
                    var j, I, B, z, E, D, O, X, H, W, U, K, J, G, V, Y, Q, Z, ee, te, ne, ae, oe, ie, re, se, le, ce, de, ue, me, he, fe, pe;
